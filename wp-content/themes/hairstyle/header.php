...
<body <?php body_class(); ?>>
    ...
    <div class="slider-main">
      ...
      <div class="contact-strip">
      		<div class="contact-align"><div class="call"><i class="fa fa-phone fa-lg"></i>&nbsp;&nbsp;<?php echo get_theme_mod('firstcol_text','12 8888 6666'); ?></div>
									   <div class="email"><i class="fa fa-envelope-o fa-lg"></i>&nbsp;&nbsp;<a href="mailto:<?php echo get_theme_mod('secondcol_text','info@sitename.com'); ?>"><?php echo get_theme_mod('secondcol_text','info@sitename.com'); ?></a></div>
                                       <?php if(get_theme_mod('thirdcol_link',true) != '') { ?>
                                       <div class="appoint"><a href="<?php echo esc_url(get_theme_mod('thirdcol_link','#')); ?>"><?php echo get_theme_mod('thirdcol_text',__('MAKE AN APPOINTMENT','hairstyle')); ?></a></div>
                                       <?php } ?>
            </div><!-- contact-align -->
      </div><!-- contact-strip -->
            ...
            <div class="pos-handle">
				<div class="row">
					...
					<div class="col-md-9 col-sm-9">					
						<div class="toggle">
							<a class="toggleMenu" href="#"><?php _e('Menu','hairstyle'); ?></a>
						</div> 
						<div class="main-nav">
