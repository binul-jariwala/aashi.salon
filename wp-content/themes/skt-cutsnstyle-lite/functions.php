...
define('SKT_URL','https://www.sktthemes.net','skt-cutsnstyle-lite');
define('SKT_THEME_URL','https://www.sktthemes.net/themes/','skt-cutsnstyle-lite');
define('SKT_THEME_DOC','http://sktthemesdemo.net/documentation/skt-cutnstyle-doc/','skt-cutsnstyle-lite');
define('SKT_PRO_THEME_URL','https://www.sktthemes.net/shop/cutsnstyle/','skt-cutsnstyle-lite');
define('SKT_PRO_FONT_AWESOME_URL','http://fortawesome.github.io/Font-Awesome/icons/','skt-cutsnstyle-lite');
define('SKT_FREE_THEME_URL','https://www.sktthemes.net/shop/cutsnstyle-lite/','skt-cutsnstyle-lite');
define('SKT_LIVE_DEMO','http://sktthemesdemo.net/cutsnstyle/','skt-cutsnstyle-lite');


function skt_cutsnstyle_lite_credit(){
		return "&copy; 2016 <span>SKT Cutsnstyle</span>. All Rights Reserved";		
}
